...
export default function FeedPostListItem(props: FeedPostListItemProps) {
  ...
  return (
    <Link
      ...
      className='flex justify-between p-[1.125rem] bg-[#f9fafb] rounded-2xl hover:bg-[#f2f4f6] duration-200'
    >
      <div className='w-full flex flex-col justify-center gap-y-2'>
        <div className='w-full flex flex-col justify-start gap-y-2'>
          <div className='flex justify-between items-center'>
            ...
            <span className='text-xs text-[#4e5968] text-right'>
