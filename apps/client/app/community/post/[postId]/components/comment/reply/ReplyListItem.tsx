...
export default function ReplyListItem(props: ReplyListItemProps) {
  ...
  const [isLikedReply, setIsLikedReply] = useState<boolean>(false);
          ...
          >
            ...
            <span
              className={`ml-[1.375rem] ${
                isLikedReply ? "text-gray-600" : "text-[#8b95a1]"
              } text-xs`}
            >
              {replyInfo.likeCount}
            </span>
